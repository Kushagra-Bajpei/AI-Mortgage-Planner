...
const sections = [
  {
    ...
    content: `We collect information you provide directly to us, such as when you create an account, submit mortgage details, or contact us. This includes:
    
• **Account information**: Name, email address, and password when you register.
• **Mortgage data**: The financial details, income, and property information you share with MortgageAI's system.
...
• Provide, maintain, and improve our AI mortgage planning services.
...
• Detect, investigate, and prevent fraudulent or unauthorized activity.`,
  ...
  {
    title: '3. Financial Data & Privacy',
    content: `Your financial data is deeply personal. We treat it accordingly:
 
• Financial details and mortgage plans are encrypted at rest using AES-256-GCM.
• Your data is **never sold** to third parties for advertising or profiling.
• We do not use your financial content to train third-party AI models without explicit consent.
• You can delete your chat history and calculations at any time from your account settings.
...
• **Business transfers**: In connection with a merger, acquisition, or sale of assets, with appropriate notice.`,
  },
  {
    ...
    content: `We retain your personal information for as long as necessary to provide our services and comply with legal obligations. You may request deletion of your account and associated data at any time by contacting us at privacy@mortgageai.com or through your account settings.`,
  },
  {
    title: '6. Your Rights',
...
To exercise these rights, contact us at privacy@mortgageai.com.`,
  },
  {
    title: '7. Security',
  ...
  },
  {
    ...
    content: `We may update this Privacy Policy from time to time. We will notify you of significant changes via email or a prominent notice on our website. Your continued use of MortgageAI after changes take effect constitutes your acceptance of the revised policy.`,
  },
  {
    title: '9. Contact Us',
    content: `If you have questions about this Privacy Policy or our data practices, please contact us at:\n\nprivacy@mortgageai.com\n\nMortgageAI Inc., 456 Finance Avenue, San Francisco, CA 94105`,
  },
];
        ...
        <div className="max-w-3xl mx-auto px-4 text-center relative">
          <FadeIn>
            ...
            <p className={`text-xl leading-relaxed mt-4 ${dark ? 'text-slate-400' : 'text-slate-600'}`}>
              Your privacy matters to us. This policy explains how MortgageAI collects, uses, and protects your information.
            </p>
          </FadeIn>
        </div>
      </section>
